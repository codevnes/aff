...
<body>
    ...
    */
    import indexPage from '<?php echo AFF_URL ?>/public/partials/pages/dashboard.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import collaboratorPage from '<?php echo AFF_URL ?>/public/partials/pages/dashboard-2.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import historyPage from '<?php echo AFF_URL ?>/public/partials/pages/history.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import paymentPage from '<?php echo AFF_URL ?>/public/partials/pages/payment.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import userPage from '<?php echo AFF_URL ?>/public/partials/pages/user.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import toolPage from '<?php echo AFF_URL ?>/public/partials/pages/tool.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import loginPage from '<?php echo AFF_URL ?>/public/partials/pages/login.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import registerPage from '<?php echo AFF_URL ?>/public/partials/pages/register.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import profilePage from '<?php echo AFF_URL ?>/public/partials/pages/user-profile.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import bannerPage from '<?php echo AFF_URL ?>/public/partials/pages/banner.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    ...
    import {
        getUserProfile,
        logout
    } from "<?php echo AFF_URL ?>/public/partials/api/user.js?ver=<?php echo WP_AFF_Pro_VERSION ?>";
    import {
        route
    } from "<?php echo AFF_URL ?>/public/partials/constants/constants.js?ver=<?php echo WP_AFF_Pro_VERSION ?>";
