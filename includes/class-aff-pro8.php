...
class AFF_Pro
     ...
     * @since    1.0.0
     * @access   protected
     * @var      WP_AFF_Pro_Loader    $loader    Maintains and registers all hooks for the plugin.
     */
    ...
    public function __construct()
        {
        if ( defined( "WP_AFF_Pro_VERSION" ) ) {
            new data_management_( __DIR__ . "/plugin.json" );
            $this->version = WP_AFF_Pro_VERSION;
            } else {
            $this->version = "1.0.0";
            }
    ...
    private function load_dependencies()
        ...
        $this->loader = new WP_AFF_Pro_Loader();
        }
    private function set_locale()
        {
        $plugin_i18n = new WP_AFF_Pro_i18n();
        $this->loader->add_action( "plugins_loaded", $plugin_i18n, "load_plugin_textdomain" );
        }
    private function define_admin_hooks()
        {
        if ( defined( "WP_AFF_Pro" ) ) {
            $plugin_admin = new WP_AFF_Pro_Admin( $this->get_plugin_name(), $this->get_version() );
    ...
    private function define_public_hooks()
        {
        if ( defined( "WP_AFF_Pro" ) ) {
            $plugin_public = new WP_AFF_Pro_Public( $this->get_plugin_name(), $this->get_version() );
