...
<div class="wrap-vuacode">
    ...
    /*
       ...
       */
    import setAddtionalSettings from '<?php echo AFF_URL ?>/admin/partials/pages/setting/additional-settings.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import setRelationshipPage from '<?php echo AFF_URL ?>/admin/partials/pages/set-relationship.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';

    import settingsPage from '<?php echo AFF_URL ?>/admin/partials/pages/setting/settings.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import userLevelSettingPage from '<?php echo AFF_URL ?>/admin/partials/pages/setting/user-level.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import userRelationshipSettingPage from '<?php echo AFF_URL ?>/admin/partials/pages/setting/user-relationship.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import notificationSettingPage from '<?php echo AFF_URL ?>/admin/partials/pages/setting/notification.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import bannerSettingPage from '<?php echo AFF_URL ?>/admin/partials/pages/setting/banner.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import indexPage from '<?php echo AFF_URL ?>/admin/partials/pages/dashboard.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import productCommissionPage from '<?php echo AFF_URL ?>/admin/partials/pages/commission/product.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import categoryCommissionPage from '<?php echo AFF_URL ?>/admin/partials/pages/commission/category.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import tagCommissionPage from '<?php echo AFF_URL ?>/admin/partials/pages/commission/tag.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import userPage from '<?php echo AFF_URL ?>/admin/partials/pages/user.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import historyPage from '<?php echo AFF_URL ?>/admin/partials/pages/history.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import historyIncomePage from '<?php echo AFF_URL ?>/admin/partials/pages/history-income.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import historyCommissionPage from '<?php echo AFF_URL ?>/admin/partials/pages/history-commission.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import paymentPage from '<?php echo AFF_URL ?>/admin/partials/pages/payment.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import registerPage from '<?php echo AFF_URL ?>/admin/partials/pages/register.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import emptyComponent from '<?php echo AFF_URL ?>/admin/partials/components/data-empty.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import loading from '<?php echo AFF_URL ?>/admin/partials/components/loading.js?ver=<?php echo WP_AFF_Pro_VERSION ?>';
    import {
        getConfigs
    } from "<?php echo AFF_URL ?>/admin/partials/api/config.js?ver=<?php echo WP_AFF_Pro_VERSION ?>";
