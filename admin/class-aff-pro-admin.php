...
class AFF_Pro_Admin
	...
	public function enqueue_styles()
		 ...
		 * defined in WP_AFF_Pro_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The WP_AFF_Pro_Loader will then create the relationship
